	...
	const init = function() {
		...
		function decreaseCost(cost, price, amount) {
			...
			if (totalProductCount < 1) {
				TweenMax.to('#tinybee1', .5, {alpha: 0});
			} if (totalProductCount < 2) {
				TweenMax.to('#tinybee2', .5, {alpha: 0});
			} if (totalProductCount < 3) {
				TweenMax.to('#tinybee3', .5, {alpha: 0});
			} if (totalProductCount < 4) {
				TweenMax.to('#tinybee4', .5, {alpha: 0});
			}
			if (totalProductCount < 5) {
				TweenMax.to('#tinybee5', .5, {alpha: 0});
			}
			return currentCost;
		}
